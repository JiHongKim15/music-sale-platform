...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-[#E0E7EF] bg-surface text-card-foreground shadow-lg p-8 transition-all duration-200 hover:shadow-xl hover:scale-[1.02] active:scale-100 cursor-pointer",
      className
    )}
    {...props}
  />
